# Eda Kicad Footprint Kicad Default Connector IDc IDc Header 2X06 1Mp P2 54mm Latch Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_idc_idc_header_2x06_1mp_p2_54mm_latch_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_idc
  * description_extra: idc_header_2x06_1mp_p2_54mm_latch_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: peach dragon blowfish
* oomp_word_emoji :peach: :dragon: :blowfish:
* md5_6_alpha: 81un1
* md5_6: ce595d
...
| description_extra_name | IDc Header 2X06 1Mp P2 54mm Latch Vertical |  
