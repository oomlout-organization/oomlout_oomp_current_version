# Eda Kicad Footprint Kicad Default Testpoint Testpoint Keystone 5005 5009 Compact  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: testpoint
  * description_extra: testpoint_keystone_5005_5009_compact
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: sparkles grapes school
* oomp_word_emoji :sparkles: :grapes: :school:
* md5_6_alpha: m6s6
* md5_6: 0fcbd6
...
| description_extra_name | Testpoint Keystone 5005 5009 Compact |  
...
| directory | parts/eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| footprint_id | eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| footprint_string | {'attributes': "Attributes(type='through_hole', boardOnly=False, excludeFromPosFiles=False, excludeFromBom=False)", 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Keystone Miniature THM Test Point 5005-5009, http://www.keyelco.com/product-pdf.cfm?p=1314', 'entryName': 'TestPoint_Keystone_5005-5009_Compact', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=1.75, Y=0, angle=None, unlocked=False), layer='F.SilkS', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=2, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpLine(start=Position(X=-1.25, Y=-0.4, angle=None, unlocked=False), end=Position(X=1.25, Y=-0.4, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.15, type='solid', color=None), locked=False, tstamp=None), FpLine(start=Position(X=-1.25, Y=0.4, angle=None, unlocked=False), end=Position(X=-1.25, Y=-0.4, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.15, type='solid', color=None), locked=False, tstamp=None), FpLine(start=Position(X=1.25, Y=-0.4, angle=None, unlocked=False), end=Position(X=1.25, Y=0.4, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.15, type='solid', color=None), locked=False, tstamp=None), FpLine(start=Position(X=1.25, Y=0.4, angle=None, unlocked=False), end=Position(X=-1.25, Y=0.4, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.15, type='solid', color=None), locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=1.6, Y=0, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=0.6, width=0.6, thickness=0.09, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': "[Model(path='${KICAD8_3DMODEL_DIR}/TestPoint.3dshapes/TestPoint_Keystone_5005-5009_Compact.wrl', pos=Coordinate(X=0, Y=0, Z=0), scale=Coordinate(X=1, Y=1, Z=1), rotate=Coordinate(X=0, Y=0, Z=0), hide=False)]", 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=2.8, Y=2.8, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=1.6, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'TestPoint_Keystone_5005-5009_Compact', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'Through Hole Mount Test Points', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| id | eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| id_no_class | eda_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| id_no_color | edatestpointtestpointkeystone50055009compact |  
| id_no_size | edatestpointtestpointkeystone50055009compact |  
| id_no_type | eda_testpoint_testpoint_keystone_5005_5009_compact |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 0fcbd62984a61b3baede3e7e541c9f3e |  
| md5_10 | 0fcbd62984 |  
| md5_10_upper | 0FCBD62984 |  
| md5_5 | 0fcbd |  
| md5_5_upper | 0FCBD |  
| md5_6 | 0fcbd6 |  
| md5_6_alpha | m6s6 |  
| md5_6_alpha_upper | M6S6 |  
| md5_6_upper | 0FCBD6 |  
| name | Eda Kicad Footprint Kicad Default Testpoint Testpoint Keystone 5005 5009 Compact |  
| name_no_class | Eda Kicad Default Testpoint Testpoint Keystone 5005 5009 Compact |  
| name_no_color | Edatestpointtestpointkeystone50055009Compact |  
| name_no_size | Edatestpointtestpointkeystone50055009Compact |  
| name_no_type | Eda Testpoint Testpoint Keystone 5005 5009 Compact |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_testpoint_testpoint_keystone_5005_5009_compact |  
| oomp_word | sparkles grapes school |  
| oomp_word_emoji | :sparkles: :grapes: :school: |  
| oomp_word_emoji_list | [':sparkles:', ':grapes:', ':school:'] |  
| oomp_word_list | ['sparkles', 'grapes', 'school'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
