# Eda Kicad Footprint Kicad Default Testpoint Testpoint Plated Hole D5 0mm  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: testpoint
  * description_extra: testpoint_plated_hole_d5_0mm
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: door scroll egg
* oomp_word_emoji :door: :scroll: :egg:
* md5_6_alpha: 5g0xr
* md5_6: 8b8dbf
...
| description_extra_name | Testpoint Plated Hole D5 0mm |  
...
| directory | parts/eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| footprint_id | eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Plated Hole as test Point, diameter 5.0mm', 'entryName': 'TestPoint_Plated_Hole_D5.0mm', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=0, Y=3.25, angle=None, unlocked=False), layer='F.SilkS', width=None, stroke=Stroke(width=0.12, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=3.5, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=-3.95, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=6, Y=6, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=5, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'TestPoint_Plated_Hole_D5.0mm', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'test point plated hole', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| id | eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| id_no_class | eda_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| id_no_color | edatestpointtestpointplatedholed50mm |  
| id_no_size | edatestpointtestpointplatedholed50mm |  
| id_no_type | eda_testpoint_testpoint_plated_hole_d5_0mm |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 8b8dbf9ee87facf7ad59fab7c3ea16e2 |  
| md5_10 | 8b8dbf9ee8 |  
| md5_10_upper | 8B8DBF9EE8 |  
| md5_5 | 8b8db |  
| md5_5_upper | 8B8DB |  
| md5_6 | 8b8dbf |  
| md5_6_alpha | 5g0xr |  
| md5_6_alpha_upper | 5G0XR |  
| md5_6_upper | 8B8DBF |  
| name | Eda Kicad Footprint Kicad Default Testpoint Testpoint Plated Hole D5 0mm |  
| name_no_class | Eda Kicad Default Testpoint Testpoint Plated Hole D5 0mm |  
| name_no_color | Edatestpointtestpointplatedholed50mm |  
| name_no_size | Edatestpointtestpointplatedholed50mm |  
| name_no_type | Eda Testpoint Testpoint Plated Hole D5 0mm |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_testpoint_testpoint_plated_hole_d5_0mm |  
| oomp_word | door scroll egg |  
| oomp_word_emoji | :door: :scroll: :egg: |  
| oomp_word_emoji_list | [':door:', ':scroll:', ':egg:'] |  
| oomp_word_list | ['door', 'scroll', 'egg'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
