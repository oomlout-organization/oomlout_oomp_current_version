# Eda Kicad Footprint Kicad Default Optodevice Everlight Itr8307 Reverse  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_optodevice_everlight_itr8307_reverse
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: optodevice
  * description_extra: everlight_itr8307_reverse
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: bus ticket cyclone
* oomp_word_emoji :bus: :ticket: :cyclone:
* md5_6_alpha: 9a88f
* md5_6: edf12f
...
| description_extra_name | Everlight Itr8307 Reverse |  
