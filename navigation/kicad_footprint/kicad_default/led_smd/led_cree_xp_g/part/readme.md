# Eda Kicad Footprint Kicad Default LED SMD LED Cree Xp G  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_led_smd_led_cree_xp_g
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: led_smd
  * description_extra: led_cree_xp_g
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: sleeping bear clap
* oomp_word_emoji :sleeping: :bear: :clap:
* md5_6_alpha: 8r2y
* md5_6: 063b1a
...
| description_extra_name | LED Cree Xp G |  
