# Eda Kicad Footprint Kicad Default LED SMD LED Cree Xp  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_led_smd_led_cree_xp
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: led_smd
  * description_extra: led_cree_xp
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: koala smile birthday
* oomp_word_emoji :koala: :smile: :birthday:
* md5_6_alpha: 29haa
* md5_6: 3a01c2
...
| description_extra_name | LED Cree Xp |  
