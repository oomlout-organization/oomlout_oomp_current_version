# Eda Kicad Footprint Kicad Default Button Switch SMD Sw Push 1P1T Sh No Ck Kmr2Xxg  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_smd_sw_push_1p1t_sh_no_ck_kmr2xxg
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_smd
  * description_extra: sw_push_1p1t_sh_no_ck_kmr2xxg
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: tophat gift coffee
* oomp_word_emoji :tophat: :gift: :coffee:
* md5_6_alpha: 6uh10
* md5_6: af77b4
...
| description_extra_name | Sw Push 1P1T Sh No Ck Kmr2Xxg |  
