# Eda Kicad Footprint Kicad Default Connector Jst Jst Xh B5B Xh Am 1X05 P2 50mm Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_jst_jst_xh_b5b_xh_am_1x05_p2_50mm_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_jst
  * description_extra: jst_xh_b5b_xh_am_1x05_p2_50mm_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: pineapple mouse strawberry
* oomp_word_emoji :pineapple: :mouse: :strawberry:
* md5_6_alpha: 879ot
* md5_6: d234cd
...
| description_extra_name | Jst Xh B5B Xh Am 1X05 P2 50mm Vertical |  
