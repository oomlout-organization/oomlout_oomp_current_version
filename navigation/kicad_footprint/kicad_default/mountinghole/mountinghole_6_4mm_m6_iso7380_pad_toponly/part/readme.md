# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 4mm M6 Iso7380 Pad Toponly  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_6_4mm_m6_iso7380_pad_toponly
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: thumbsup blossom lock
* oomp_word_emoji :thumbsup: :blossom: :lock:
* md5_6_alpha: vhxf
* md5_6: 166c83
...
| description_extra_name | Mountinghole 6 4mm M6 Iso7380 Pad Toponly |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 6.4mm, M6, ISO7380', 'entryName': 'MountingHole_6.4mm_M6_ISO7380_Pad_TopOnly', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=5.25, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=5.5, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=6.8, Y=6.8, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=6.4, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[]), Pad(number='1', type='connect', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=10.5, Y=10.5, angle=None, unlocked=False), drill=None, layers=['F.Cu', 'F.Mask'], property=None, removeUnusedLayers=False, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_6.4mm_M6_ISO7380_Pad_TopOnly', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 6.4mm m6 iso7380', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| id_no_color | edamountingholemountinghole64mmm6iso7380padtoponly |  
| id_no_size | edamountingholemountinghole64mmm6iso7380padtoponly |  
| id_no_type | eda_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 166c83f5405f6fe150e5a07ce45b887b |  
| md5_10 | 166c83f540 |  
| md5_10_upper | 166C83F540 |  
| md5_5 | 166c8 |  
| md5_5_upper | 166C8 |  
| md5_6 | 166c83 |  
| md5_6_alpha | vhxf |  
| md5_6_alpha_upper | VHXF |  
| md5_6_upper | 166C83 |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 4mm M6 Iso7380 Pad Toponly |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 6 4mm M6 Iso7380 Pad Toponly |  
| name_no_color | Edamountingholemountinghole64mmm6Iso7380Padtoponly |  
| name_no_size | Edamountingholemountinghole64mmm6Iso7380Padtoponly |  
| name_no_type | Eda Mountinghole Mountinghole 6 4mm M6 Iso7380 Pad Toponly |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_iso7380_pad_toponly |  
| oomp_word | thumbsup blossom lock |  
| oomp_word_emoji | :thumbsup: :blossom: :lock: |  
| oomp_word_emoji_list | [':thumbsup:', ':blossom:', ':lock:'] |  
| oomp_word_list | ['thumbsup', 'blossom', 'lock'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
