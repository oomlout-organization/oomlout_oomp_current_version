# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 4mm Pad  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_4mm_pad
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cactus computer fire
* oomp_word_emoji :cactus: :computer: :fire:
* md5_6_alpha: 445xw
* md5_6: 697b14
...
| description_extra_name | Mountinghole 4mm Pad |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 4mm', 'entryName': 'MountingHole_4mm_Pad', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=4, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=4.25, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=8, Y=8, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=4, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_4mm_Pad', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 4mm', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_4mm_pad |  
| id_no_color | edamountingholemountinghole4mmpad |  
| id_no_size | edamountingholemountinghole4mmpad |  
| id_no_type | eda_mountinghole_mountinghole_4mm_pad |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 697b1418ddcb52140e1465f610c660b5 |  
| md5_10 | 697b1418dd |  
| md5_10_upper | 697B1418DD |  
| md5_5 | 697b1 |  
| md5_5_upper | 697B1 |  
| md5_6 | 697b14 |  
| md5_6_alpha | 445xw |  
| md5_6_alpha_upper | 445XW |  
| md5_6_upper | 697B14 |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 4mm Pad |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 4mm Pad |  
| name_no_color | Edamountingholemountinghole4mmpad |  
| name_no_size | Edamountingholemountinghole4mmpad |  
| name_no_type | Eda Mountinghole Mountinghole 4mm Pad |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_4mm_pad |  
| oomp_word | cactus computer fire |  
| oomp_word_emoji | :cactus: :computer: :fire: |  
| oomp_word_emoji_list | [':cactus:', ':computer:', ':fire:'] |  
| oomp_word_list | ['cactus', 'computer', 'fire'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
