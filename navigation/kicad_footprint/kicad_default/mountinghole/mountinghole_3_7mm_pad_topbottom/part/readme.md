# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 3 7mm Pad Topbottom  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad_topbottom
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_3_7mm_pad_topbottom
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: hamburger ear koala
* oomp_word_emoji :hamburger: :ear: :koala:
* md5_6_alpha: 76nui
* md5_6: b8253a
...
| description_extra_name | Mountinghole 3 7mm Pad Topbottom |  
