# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 3 5mm Pad  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_3_5mm_pad
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: santa cow phone
* oomp_word_emoji :santa: :cow: :phone:
* md5_6_alpha: 4m35p
* md5_6: 763d7d
...
| description_extra_name | Mountinghole 3 5mm Pad |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 3.5mm', 'entryName': 'MountingHole_3.5mm_Pad', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=3.5, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=3.75, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=7, Y=7, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=3.5, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_3.5mm_Pad', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 3.5mm', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| id_no_color | edamountingholemountinghole35mmpad |  
| id_no_size | edamountingholemountinghole35mmpad |  
| id_no_type | eda_mountinghole_mountinghole_3_5mm_pad |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 763d7d1c033c25385bedd2235d3a430d |  
| md5_10 | 763d7d1c03 |  
| md5_10_upper | 763D7D1C03 |  
| md5_5 | 763d7 |  
| md5_5_upper | 763D7 |  
| md5_6 | 763d7d |  
| md5_6_alpha | 4m35p |  
| md5_6_alpha_upper | 4M35P |  
| md5_6_upper | 763D7D |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 3 5mm Pad |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 3 5mm Pad |  
| name_no_color | Edamountingholemountinghole35mmpad |  
| name_no_size | Edamountingholemountinghole35mmpad |  
| name_no_type | Eda Mountinghole Mountinghole 3 5mm Pad |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_5mm_pad |  
| oomp_word | santa cow phone |  
| oomp_word_emoji | :santa: :cow: :phone: |  
| oomp_word_emoji_list | [':santa:', ':cow:', ':phone:'] |  
| oomp_word_list | ['santa', 'cow', 'phone'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
