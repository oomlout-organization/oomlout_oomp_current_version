# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 3 7mm Pad  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_3_7mm_pad
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: egg watch handbag
* oomp_word_emoji :egg: :watch: :handbag:
* md5_6_alpha: 7h036
* md5_6: bf81b2
...
| description_extra_name | Mountinghole 3 7mm Pad |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 3.7mm', 'entryName': 'MountingHole_3.7mm_Pad', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=3.7, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=3.95, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=7.4, Y=7.4, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=3.7, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_3.7mm_Pad', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 3.7mm', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| id_no_color | edamountingholemountinghole37mmpad |  
| id_no_size | edamountingholemountinghole37mmpad |  
| id_no_type | eda_mountinghole_mountinghole_3_7mm_pad |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | bf81b2e8128055dcf2267d19b47f551a |  
| md5_10 | bf81b2e812 |  
| md5_10_upper | BF81B2E812 |  
| md5_5 | bf81b |  
| md5_5_upper | BF81B |  
| md5_6 | bf81b2 |  
| md5_6_alpha | 7h036 |  
| md5_6_alpha_upper | 7H036 |  
| md5_6_upper | BF81B2 |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 3 7mm Pad |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 3 7mm Pad |  
| name_no_color | Edamountingholemountinghole37mmpad |  
| name_no_size | Edamountingholemountinghole37mmpad |  
| name_no_type | Eda Mountinghole Mountinghole 3 7mm Pad |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_3_7mm_pad |  
| oomp_word | egg watch handbag |  
| oomp_word_emoji | :egg: :watch: :handbag: |  
| oomp_word_emoji_list | [':egg:', ':watch:', ':handbag:'] |  
| oomp_word_list | ['egg', 'watch', 'handbag'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
