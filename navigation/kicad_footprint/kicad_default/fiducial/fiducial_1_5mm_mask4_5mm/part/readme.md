# Eda Kicad Footprint Kicad Default Fiducial Fiducial 1 5mm Mask4 5mm  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: fiducial
  * description_extra: fiducial_1_5mm_mask4_5mm
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: recycle computer cloud
* oomp_word_emoji :recycle: :computer: :cloud:
* md5_6_alpha: 9xgkr
* md5_6: fe7b2b
...
| description_extra_name | Fiducial 1 5mm Mask4 5mm |  
...
| directory | parts/eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| footprint_id | eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| footprint_string | {'attributes': "Attributes(type='smd', boardOnly=False, excludeFromPosFiles=False, excludeFromBom=False)", 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Circular Fiducial, 1.5mm bare copper, 4.5mm soldermask opening', 'entryName': 'Fiducial_1.5mm_Mask4.5mm', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=2.5, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=2.25, Y=0, angle=None, unlocked=False), layer='F.Fab', width=None, stroke=Stroke(width=0.1, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=0.4, width=0.4, thickness=0.06, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='', type='smd', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=1.5, Y=1.5, angle=None, unlocked=False), drill=None, layers=['F.Cu', 'F.Mask'], property=None, removeUnusedLayers=False, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=1.5, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=1.5, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'Fiducial_1.5mm_Mask4.5mm', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'fiducial', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| id | eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| id_no_class | eda_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| id_no_color | edafiducialfiducial15mmmask45mm |  
| id_no_size | edafiducialfiducial15mmmask45mm |  
| id_no_type | eda_fiducial_fiducial_1_5mm_mask4_5mm |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | fe7b2bcbd32453da0fccf8adc55963f6 |  
| md5_10 | fe7b2bcbd3 |  
| md5_10_upper | FE7B2BCBD3 |  
| md5_5 | fe7b2 |  
| md5_5_upper | FE7B2 |  
| md5_6 | fe7b2b |  
| md5_6_alpha | 9xgkr |  
| md5_6_alpha_upper | 9XGKR |  
| md5_6_upper | FE7B2B |  
| name | Eda Kicad Footprint Kicad Default Fiducial Fiducial 1 5mm Mask4 5mm |  
| name_no_class | Eda Kicad Default Fiducial Fiducial 1 5mm Mask4 5mm |  
| name_no_color | Edafiducialfiducial15mmmask45mm |  
| name_no_size | Edafiducialfiducial15mmmask45mm |  
| name_no_type | Eda Fiducial Fiducial 1 5mm Mask4 5mm |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_fiducial_fiducial_1_5mm_mask4_5mm |  
| oomp_word | recycle computer cloud |  
| oomp_word_emoji | :recycle: :computer: :cloud: |  
| oomp_word_emoji_list | [':recycle:', ':computer:', ':cloud:'] |  
| oomp_word_list | ['recycle', 'computer', 'cloud'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
