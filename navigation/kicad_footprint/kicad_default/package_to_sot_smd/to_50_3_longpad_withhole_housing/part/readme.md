# Eda Kicad Footprint Kicad Default Package To Sot SMD To 50 3 Longpad Withhole Housing  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_package_to_sot_smd_to_50_3_longpad_withhole_housing
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: package_to_sot_smd
  * description_extra: to_50_3_longpad_withhole_housing
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: grapes pineapple whale
* oomp_word_emoji :grapes: :pineapple: :whale:
* md5_6_alpha: 7yatw
* md5_6: cbd254
...
| description_extra_name | To 50 3 Longpad Withhole Housing |  
