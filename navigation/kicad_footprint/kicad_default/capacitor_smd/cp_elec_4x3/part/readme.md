# Eda Kicad Footprint Kicad Default Capacitor SMD Cp Elec 4X3  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_capacitor_smd_cp_elec_4x3
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: capacitor_smd
  * description_extra: cp_elec_4x3
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: radio bread camel
* oomp_word_emoji :radio: :bread: :camel:
* md5_6_alpha: 53nsx
* md5_6: 82c041
...
| description_extra_name | Cp Elec 4X3 |  
