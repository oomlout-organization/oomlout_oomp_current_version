# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Mbh 0 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3mbh_0_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3mbh_0_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: snowman hearts koala
* oomp_word_emoji :snowman: :hearts: :koala:
* md5_6_alpha: 1s2m2
* md5_6: 2d9d3a
...
| description_extra_name | Jack Xlr Neutrik Nc3Mbh 0 Horizontal |  
