# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faav Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faav_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faav_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: parking eyeglasses spaghetti
* oomp_word_emoji :parking: :eyeglasses: :spaghetti:
* md5_6_alpha: 9wd6i
* md5_6: fdb3ba
...
| description_extra_name | Jack Xlr Neutrik Nc3Faav Vertical |  
