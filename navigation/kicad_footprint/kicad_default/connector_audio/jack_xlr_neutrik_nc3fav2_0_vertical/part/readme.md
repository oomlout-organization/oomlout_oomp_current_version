# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fav2 0 Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fav2_0_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fav2_0_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: six bouquet hatched_chick
* oomp_word_emoji :six: :bouquet: :hatched_chick:
* md5_6_alpha: 9nhhk
* md5_6: f76148
...
| description_extra_name | Jack Xlr Neutrik Nc3Fav2 0 Vertical |  
