# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fah1 0 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fah1_0_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fah1_0_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: whale cake curry
* oomp_word_emoji :whale: :cake: :curry:
* md5_6_alpha: 3b2d7
* md5_6: 54c3bb
...
| description_extra_name | Jack Xlr Neutrik Nc3Fah1 0 Horizontal |  
