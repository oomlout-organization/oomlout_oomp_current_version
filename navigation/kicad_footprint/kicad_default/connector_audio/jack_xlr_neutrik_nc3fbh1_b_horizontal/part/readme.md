# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbh1 B Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbh1_b_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbh1_b_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: snake sandal books
* oomp_word_emoji :snake: :sandal: :books:
* md5_6_alpha: 2puoj
* md5_6: 45a993
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbh1 B Horizontal |  
