# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fav Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fav_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fav_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: squirrel turtle racehorse
* oomp_word_emoji :squirrel: :turtle: :racehorse:
* md5_6_alpha: 4dqo0
* md5_6: 704c40
...
| description_extra_name | Jack Xlr Neutrik Nc3Fav Vertical |  
