# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbv2 B Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbv2_b_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbv2_b_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: hamburger strawberry bird
* oomp_word_emoji :hamburger: :strawberry: :bird:
* md5_6_alpha: 77l1i
* md5_6: b8cd46
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbv2 B Vertical |  
