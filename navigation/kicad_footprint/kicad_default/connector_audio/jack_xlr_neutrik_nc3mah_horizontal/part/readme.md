# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Mah Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3mah_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3mah_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: boot question jeans
* oomp_word_emoji :boot: :question: :jeans:
* md5_6_alpha: 6oazy
* md5_6: ab13ae
...
| description_extra_name | Jack Xlr Neutrik Nc3Mah Horizontal |  
