# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faah Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faah_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faah_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: stars droplet baby
* oomp_word_emoji :stars: :droplet: :baby:
* md5_6_alpha: 8mmn1
* md5_6: dd241d
...
| description_extra_name | Jack Xlr Neutrik Nc3Faah Horizontal |  
