# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbh1 E Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbh1_e_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbh1_e_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: pear kissing foggy
* oomp_word_emoji :pear: :kissing: :foggy:
* md5_6_alpha: 85lps
* md5_6: d10530
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbh1 E Horizontal |  
