# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faah2 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faah2_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faah2_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: tram ox apple
* oomp_word_emoji :tram: :ox: :apple:
* md5_6_alpha: 92e2w
* md5_6: e85cc8
...
| description_extra_name | Jack Xlr Neutrik Nc3Faah2 Horizontal |  
