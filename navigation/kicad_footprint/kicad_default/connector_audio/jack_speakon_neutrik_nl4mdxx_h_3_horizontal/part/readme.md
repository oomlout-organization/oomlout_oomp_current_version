# Eda Kicad Footprint Kicad Default Connector Audio Jack Speakon Neutrik Nl4Mdxx H 3 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_speakon_neutrik_nl4mdxx_h_3_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_speakon_neutrik_nl4mdxx_h_3_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: scroll trumpet penguin
* oomp_word_emoji :scroll: :trumpet: :penguin:
* md5_6_alpha: 5iyx7
* md5_6: 8da64b
...
| description_extra_name | Jack Speakon Neutrik Nl4Mdxx H 3 Horizontal |  
