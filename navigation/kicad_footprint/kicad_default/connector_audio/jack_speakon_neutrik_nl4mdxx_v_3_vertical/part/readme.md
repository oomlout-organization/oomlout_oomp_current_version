# Eda Kicad Footprint Kicad Default Connector Audio Jack Speakon Neutrik Nl4Mdxx V 3 Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_speakon_neutrik_nl4mdxx_v_3_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_speakon_neutrik_nl4mdxx_v_3_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cake kissing santa
* oomp_word_emoji :cake: :kissing: :santa:
* md5_6_alpha: 7lxti
* md5_6: c30576
...
| description_extra_name | Jack Speakon Neutrik Nl4Mdxx V 3 Vertical |  
