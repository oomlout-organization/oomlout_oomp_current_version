# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fah2 Da Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fah2_da_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fah2_da_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: wolf speaker lock
* oomp_word_emoji :wolf: :speaker: :lock:
* md5_6_alpha: 25yf7
* md5_6: 377f83
...
| description_extra_name | Jack Xlr Neutrik Nc3Fah2 Da Horizontal |  
