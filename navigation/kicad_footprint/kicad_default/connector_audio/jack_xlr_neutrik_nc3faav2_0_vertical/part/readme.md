# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faav2 0 Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faav2_0_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faav2_0_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: banana hand cherries
* oomp_word_emoji :banana: :hand: :cherries:
* md5_6_alpha: 84b0q
* md5_6: d018ca
...
| description_extra_name | Jack Xlr Neutrik Nc3Faav2 0 Vertical |  
