# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faah1 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faah1_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faah1_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: ambulance banana feet
* oomp_word_emoji :ambulance: :banana: :feet:
* md5_6_alpha: 9bg9t
* md5_6: eed021
...
| description_extra_name | Jack Xlr Neutrik Nc3Faah1 Horizontal |  
