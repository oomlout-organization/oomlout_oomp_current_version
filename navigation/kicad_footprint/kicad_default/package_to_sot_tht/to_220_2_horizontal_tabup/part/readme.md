# Eda Kicad Footprint Kicad Default Package To Sot Tht To 220 2 Horizontal Tabup  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_package_to_sot_tht_to_220_2_horizontal_tabup
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: package_to_sot_tht
  * description_extra: to_220_2_horizontal_tabup
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: camera new_moon cloud
* oomp_word_emoji :camera: :new_moon: :cloud:
* md5_6_alpha: 4rz1n
* md5_6: 7a6e2b
...
| description_extra_name | To 220 2 Horizontal Tabup |  
