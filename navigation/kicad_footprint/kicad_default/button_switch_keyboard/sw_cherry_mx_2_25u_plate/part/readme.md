# Eda Kicad Footprint Kicad Default Button Switch Keyboard Sw Cherry Mx 2 25U Plate  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_keyboard_sw_cherry_mx_2_25u_plate
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_keyboard
  * description_extra: sw_cherry_mx_2_25u_plate
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: taxi strawberry hearts
* oomp_word_emoji :taxi: :strawberry: :hearts:
* md5_6_alpha: 98mn1
* md5_6: eccd9d
...
| description_extra_name | Sw Cherry Mx 2 25U Plate |  
