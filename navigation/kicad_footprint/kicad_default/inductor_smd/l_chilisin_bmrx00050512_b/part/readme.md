# Eda Kicad Footprint Kicad Default Inductor SMD L Chilisin Bmrx00050512 B  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_inductor_smd_l_chilisin_bmrx00050512_b
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: inductor_smd
  * description_extra: l_chilisin_bmrx00050512_b
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: fish one fax
* oomp_word_emoji :fish: :one: :fax:
* md5_6_alpha: 39x1a
* md5_6: 53f27e
...
| description_extra_name | L Chilisin Bmrx00050512 B |  
