# Eda Kicad Footprint Kicad Default Inductor SMD L Commonmodechoke Tdk Acm2520 3P  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_inductor_smd_l_commonmodechoke_tdk_acm2520_3p
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: inductor_smd
  * description_extra: l_commonmodechoke_tdk_acm2520_3p
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: hourglass airplane tram
* oomp_word_emoji :hourglass: :airplane: :tram:
* md5_6_alpha: 512aw
* md5_6: 80e6e8
...
| description_extra_name | L Commonmodechoke Tdk Acm2520 3P |  
