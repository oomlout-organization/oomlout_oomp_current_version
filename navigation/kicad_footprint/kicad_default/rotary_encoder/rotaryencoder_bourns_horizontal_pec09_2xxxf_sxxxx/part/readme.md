# Eda Kicad Footprint Kicad Default Rotary Encoder Rotaryencoder Bourns Horizontal Pec09 2Xxxf Sxxxx  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_rotary_encoder_rotaryencoder_bourns_horizontal_pec09_2xxxf_sxxxx
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: rotary_encoder
  * description_extra: rotaryencoder_bourns_horizontal_pec09_2xxxf_sxxxx
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: blowfish rice pencil
* oomp_word_emoji :blowfish: :rice: :pencil:
* md5_6_alpha: 3no9v
* md5_6: 5dbda3
...
| description_extra_name | Rotaryencoder Bourns Horizontal Pec09 2Xxxf Sxxxx |  
