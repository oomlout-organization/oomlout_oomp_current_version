# Eda Kicad Footprint Kicad Default Terminalblock Terminalblock Altech Ak300 2 P5 00mm  
...
| oomp_word_list | ['watermelon', 'rooster', 'penguin'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
