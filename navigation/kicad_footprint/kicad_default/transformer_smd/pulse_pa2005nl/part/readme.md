# Eda Kicad Footprint Kicad Default Transformer SMD Pulse Pa2005Nl  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_transformer_smd_pulse_pa2005nl
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: transformer_smd
  * description_extra: pulse_pa2005nl
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: ghost sheep pencil
* oomp_word_emoji :ghost: :sheep: :pencil:
* md5_6_alpha: 4kplv
* md5_6: 7542a3
...
| description_extra_name | Pulse Pa2005Nl |  
