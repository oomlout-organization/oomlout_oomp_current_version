# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 5mm Pad Topbottom  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_6_5mm_pad_topbottom
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: books helicopter sunny
* oomp_word_emoji :books: :helicopter: :sunny:
* md5_6_alpha: 5rr55
* md5_6: 93e729
...
| description_extra_name | Mountinghole 6 5mm Pad Topbottom |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 6.5mm', 'entryName': 'MountingHole_6.5mm_Pad_TopBottom', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=6.5, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=6.75, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='1', type='thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=6.9, Y=6.9, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=6.5, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=True, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[]), Pad(number='1', type='connect', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=13, Y=13, angle=None, unlocked=False), drill=None, layers=['F.Cu', 'F.Mask'], property=None, removeUnusedLayers=False, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[]), Pad(number='1', type='connect', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=13, Y=13, angle=None, unlocked=False), drill=None, layers=['B.Cu', 'B.Mask'], property=None, removeUnusedLayers=False, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_6.5mm_Pad_TopBottom', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 6.5mm', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| id_no_color | edamountingholemountinghole65mmpadtopbottom |  
| id_no_size | edamountingholemountinghole65mmpadtopbottom |  
| id_no_type | eda_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 93e729166f4b6d21af3bff000595dd1f |  
| md5_10 | 93e729166f |  
| md5_10_upper | 93E729166F |  
| md5_5 | 93e72 |  
| md5_5_upper | 93E72 |  
| md5_6 | 93e729 |  
| md5_6_alpha | 5rr55 |  
| md5_6_alpha_upper | 5RR55 |  
| md5_6_upper | 93E729 |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 5mm Pad Topbottom |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 6 5mm Pad Topbottom |  
| name_no_color | Edamountingholemountinghole65mmpadtopbottom |  
| name_no_size | Edamountingholemountinghole65mmpadtopbottom |  
| name_no_type | Eda Mountinghole Mountinghole 6 5mm Pad Topbottom |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_topbottom |  
| oomp_word | books helicopter sunny |  
| oomp_word_emoji | :books: :helicopter: :sunny: |  
| oomp_word_emoji_list | [':books:', ':helicopter:', ':sunny:'] |  
| oomp_word_list | ['books', 'helicopter', 'sunny'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
