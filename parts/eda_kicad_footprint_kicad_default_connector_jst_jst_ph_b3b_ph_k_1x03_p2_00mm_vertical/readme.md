# Eda Kicad Footprint Kicad Default Connector Jst Jst Ph B3B Ph K 1X03 P2 00mm Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_jst_jst_ph_b3b_ph_k_1x03_p2_00mm_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_jst
  * description_extra: jst_ph_b3b_ph_k_1x03_p2_00mm_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: angry ambulance bell
* oomp_word_emoji :angry: :ambulance: :bell:
* md5_6_alpha: dy7s
* md5_6: 09ee78
...
| description_extra_name | Jst Ph B3B Ph K 1X03 P2 00mm Vertical |  
