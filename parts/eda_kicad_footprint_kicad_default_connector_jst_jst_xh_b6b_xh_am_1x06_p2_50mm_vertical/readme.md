# Eda Kicad Footprint Kicad Default Connector Jst Jst Xh B6B Xh Am 1X06 P2 50mm Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_jst_jst_xh_b6b_xh_am_1x06_p2_50mm_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_jst
  * description_extra: jst_xh_b6b_xh_am_1x06_p2_50mm_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: watch hospital water_buffalo
* oomp_word_emoji :watch: :hospital: :water_buffalo:
* md5_6_alpha: 52dzs
* md5_6: 81d858
...
| description_extra_name | Jst Xh B6B Xh Am 1X06 P2 50mm Vertical |  
