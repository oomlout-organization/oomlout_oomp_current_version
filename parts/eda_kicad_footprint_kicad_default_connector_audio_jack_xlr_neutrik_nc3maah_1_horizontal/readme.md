# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Maah 1 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3maah_1_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3maah_1_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: fax briefcase turtle
* oomp_word_emoji :fax: :briefcase: :turtle:
* md5_6_alpha: 4xyks
* md5_6: 7eb14c
...
| description_extra_name | Jack Xlr Neutrik Nc3Maah 1 Horizontal |  
