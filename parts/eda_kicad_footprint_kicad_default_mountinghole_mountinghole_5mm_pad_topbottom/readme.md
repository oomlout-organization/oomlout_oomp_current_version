# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 5mm Pad Topbottom  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_5mm_pad_topbottom
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_5mm_pad_topbottom
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: smile nose four
* oomp_word_emoji :smile: :nose: :four:
* md5_6_alpha: 1mgl
* md5_6: 0127f5
...
| description_extra_name | Mountinghole 5mm Pad Topbottom |  
