# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Maah Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3maah_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3maah_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: star leaves stars
* oomp_word_emoji :star: :leaves: :stars:
* md5_6_alpha: n1el
* md5_6: 1066dd
...
| description_extra_name | Jack Xlr Neutrik Nc3Maah Horizontal |  
