# Eda Kicad Footprint Kicad Default Button Switch Keyboard Sw Cherry Mx Isoenter PCB  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_keyboard_sw_cherry_mx_isoenter_pcb
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_keyboard
  * description_extra: sw_cherry_mx_isoenter_pcb
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: trident three sheep
* oomp_word_emoji :trident: :three: :sheep:
* md5_6_alpha: 9zj2a
* md5_6: fff442
...
| description_extra_name | Sw Cherry Mx Isoenter PCB |  
