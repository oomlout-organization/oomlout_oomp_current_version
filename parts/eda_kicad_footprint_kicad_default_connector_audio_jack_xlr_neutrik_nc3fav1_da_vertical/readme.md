# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fav1 Da Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fav1_da_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fav1_da_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: microscope crown cherries
* oomp_word_emoji :microscope: :crown: :cherries:
* md5_6_alpha: 5suyy
* md5_6: 94b0ca
...
| description_extra_name | Jack Xlr Neutrik Nc3Fav1 Da Vertical |  
