# Eda Kicad Footprint Kicad Default Connector IDc IDc Header 2X12 1Mp P2 54mm Latch Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_idc_idc_header_2x12_1mp_p2_54mm_latch_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_idc
  * description_extra: idc_header_2x12_1mp_p2_54mm_latch_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: stars helicopter six
* oomp_word_emoji :stars: :helicopter: :six:
* md5_6_alpha: 8npbr
* md5_6: dde7f7
...
| description_extra_name | IDc Header 2X12 1Mp P2 54mm Latch Vertical |  
