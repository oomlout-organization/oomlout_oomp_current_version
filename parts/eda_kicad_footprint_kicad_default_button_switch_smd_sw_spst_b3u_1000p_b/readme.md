# Eda Kicad Footprint Kicad Default Button Switch SMD Sw Spst B3U 1000P B  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_smd_sw_spst_b3u_1000p_b
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_smd
  * description_extra: sw_spst_b3u_1000p_b
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: bowling princess hotel
* oomp_word_emoji :bowling: :princess: :hotel:
* md5_6_alpha: 5z36i
* md5_6: 991fda
...
| description_extra_name | Sw Spst B3U 1000P B |  
