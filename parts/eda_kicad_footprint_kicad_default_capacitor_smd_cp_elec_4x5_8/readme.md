# Eda Kicad Footprint Kicad Default Capacitor SMD Cp Elec 4X5 8  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_capacitor_smd_cp_elec_4x5_8
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: capacitor_smd
  * description_extra: cp_elec_4x5_8
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: snake briefcase parking
* oomp_word_emoji :snake: :briefcase: :parking:
* md5_6_alpha: 2pwcd
* md5_6: 45b1fd
...
| description_extra_name | Cp Elec 4X5 8 |  
