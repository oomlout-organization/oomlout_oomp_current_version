# Eda Kicad Footprint Kicad Default Diode Tht Diode Bridge Ixys Gufp  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_diode_tht_diode_bridge_ixys_gufp
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: diode_tht
  * description_extra: diode_bridge_ixys_gufp
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cookie tomato baseball
* oomp_word_emoji :cookie: :tomato: :baseball:
* md5_6_alpha: 7oh3r
* md5_6: c4d397
...
| description_extra_name | Diode Bridge Ixys Gufp |  
