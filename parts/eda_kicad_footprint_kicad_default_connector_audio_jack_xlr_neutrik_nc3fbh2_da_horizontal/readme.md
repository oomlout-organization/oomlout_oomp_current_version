# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbh2 Da Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbh2_da_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbh2_da_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: banana tophat scissors
* oomp_word_emoji :banana: :tophat: :scissors:
* md5_6_alpha: 854sw
* md5_6: d0af90
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbh2 Da Horizontal |  
