# Eda Kicad Footprint Kicad Default Button Switch Tht Sw Push 2P1T Toggle Ck Pva1Xxh3Xxxxxxv2  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_tht_sw_push_2p1t_toggle_ck_pva1xxh3xxxxxxv2
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_tht
  * description_extra: sw_push_2p1t_toggle_ck_pva1xxh3xxxxxxv2
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: anger six banana
* oomp_word_emoji :anger: :six: :banana:
* md5_6_alpha: qn68
* md5_6: 12f7d0
...
| description_extra_name | Sw Push 2P1T Toggle Ck Pva1Xxh3Xxxxxxv2 |  
