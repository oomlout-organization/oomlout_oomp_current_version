# Eda Kicad Footprint Kicad Default Capacitor SMD C Elec 6 3X5 4  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_capacitor_smd_c_elec_6_3x5_4
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: capacitor_smd
  * description_extra: c_elec_6_3x5_4
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: thumbsdown dress lemon
* oomp_word_emoji :thumbsdown: :dress: :lemon:
* md5_6_alpha: x9e1
* md5_6: 17adc9
...
| description_extra_name | C Elec 6 3X5 4 |  
