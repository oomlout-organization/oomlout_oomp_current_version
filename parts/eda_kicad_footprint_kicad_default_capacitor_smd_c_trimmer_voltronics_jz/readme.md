# Eda Kicad Footprint Kicad Default Capacitor SMD C Trimmer Voltronics Jz  
...
| oomp_word_list | ['mushroom', 'house', 'peach'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
