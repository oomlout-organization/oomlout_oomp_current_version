# Eda Kicad Footprint Kicad Default LED SMD LED Cree Xq  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_led_smd_led_cree_xq
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: led_smd
  * description_extra: led_cree_xq
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: anchor boot egg
* oomp_word_emoji :anchor: :boot: :egg:
* md5_6_alpha: 8x7en
* md5_6: e4abbf
...
| description_extra_name | LED Cree Xq |  
