# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fah1 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fah1_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fah1_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: horse penguin ear
* oomp_word_emoji :horse: :penguin: :ear:
* md5_6_alpha: 2gwmd
* md5_6: 3f4b25
...
| description_extra_name | Jack Xlr Neutrik Nc3Fah1 Horizontal |  
