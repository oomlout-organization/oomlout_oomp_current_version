# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6mm  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_6mm
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: trident golf ok
* oomp_word_emoji :trident: :golf: :ok:
* md5_6_alpha: 9z1ff
* md5_6: ff9afb
...
| description_extra_name | Mountinghole 6mm |  
...
| directory | parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm |  
| footprint_id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm |  
| footprint_string | {'attributes': 'Attributes(type=None, boardOnly=False, excludeFromPosFiles=True, excludeFromBom=True)', 'autoplaceCost180': 'None', 'autoplaceCost90': 'None', 'clearance': 'None', 'description': 'Mounting Hole 6mm, no annular', 'entryName': 'MountingHole_6mm', 'filePath': 'None', 'generator': 'pcbnew', 'graphicItems': "[FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=6, Y=0, angle=None, unlocked=False), layer='Cmts.User', width=None, stroke=Stroke(width=0.15, type='solid', color=None), fill='none', locked=False, tstamp=None), FpCircle(center=Position(X=0, Y=0, angle=None, unlocked=False), end=Position(X=6.25, Y=0, angle=None, unlocked=False), layer='F.CrtYd', width=None, stroke=Stroke(width=0.05, type='solid', color=None), fill='none', locked=False, tstamp=None), FpText(type='user', text='${REFERENCE}', position=Position(X=0, Y=0, angle=0, unlocked=False), layer='F.Fab', hide=False, effects=Effects(font=Font(face=None, height=1, width=1, thickness=0.15, bold=False, italic=False, lineSpacing=None, color=None), justify=Justify(horizontally=None, vertically=None, mirror=False), hide=False, href=None), tstamp=None, renderCache=None)]", 'groups': '[]', 'layer': 'F.Cu', 'libraryNickname': 'None', 'locked': 'False', 'models': '[]', 'pads': "[Pad(number='', type='np_thru_hole', shape='circle', position=Position(X=0, Y=0, angle=None, unlocked=False), locked=False, size=Position(X=6, Y=6, angle=None, unlocked=False), drill=DrillDefinition(oval=False, diameter=6, width=None, offset=None), layers=['*.Cu', '*.Mask'], property=None, removeUnusedLayers=False, keepEndLayers=False, roundrectRatio=None, chamferRatio=None, chamfer=[], net=None, tstamp=None, pinFunction=None, pinType=None, dieLength=None, solderMaskMargin=None, solderPasteMargin=None, solderPasteMarginRatio=None, clearance=None, zoneConnect=None, thermalWidth=None, thermalGap=None, customPadOptions=None, customPadPrimitives=[])]", 'path': 'None', 'placed': 'False', 'position': 'None', 'properties': "{'Reference': 'REF**', 'Value': 'MountingHole_6mm', 'Footprint': '', 'Datasheet': '', 'Description': ''}", 'solderMaskMargin': 'None', 'solderPasteMargin': 'None', 'solderPasteRatio': 'None', 'tags': 'mounting hole 6mm no annular', 'tedit': '65faf87e', 'thermalGap': 'None', 'thermalWidth': 'None', 'tstamp': 'None', 'version': '20240108', 'zoneConnect': 'None', 'zones': '[]'} |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm |  
| id | eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm |  
| id_no_class | eda_kicad_default_mountinghole_mountinghole_6mm |  
| id_no_color | edamountingholemountinghole6mm |  
| id_no_size | edamountingholemountinghole6mm |  
| id_no_type | eda_mountinghole_mountinghole_6mm |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | ff9afb73459248cd3cf200c851b7e577 |  
| md5_10 | ff9afb7345 |  
| md5_10_upper | FF9AFB7345 |  
| md5_5 | ff9af |  
| md5_5_upper | FF9AF |  
| md5_6 | ff9afb |  
| md5_6_alpha | 9z1ff |  
| md5_6_alpha_upper | 9Z1FF |  
| md5_6_upper | FF9AFB |  
| name | Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6mm |  
| name_no_class | Eda Kicad Default Mountinghole Mountinghole 6mm |  
| name_no_color | Edamountingholemountinghole6mm |  
| name_no_size | Edamountingholemountinghole6mm |  
| name_no_type | Eda Mountinghole Mountinghole 6mm |  
| oomp_key | oomp_eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6mm |  
| oomp_word | trident golf ok |  
| oomp_word_emoji | :trident: :golf: :ok: |  
| oomp_word_emoji_list | [':trident:', ':golf:', ':ok:'] |  
| oomp_word_list | ['trident', 'golf', 'ok'] |  
| part_number |  |  
| part_number_name |  |  
| short_name |  |  
| size |  |  
