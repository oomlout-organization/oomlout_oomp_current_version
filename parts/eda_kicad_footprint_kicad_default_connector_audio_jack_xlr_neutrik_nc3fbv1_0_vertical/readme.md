# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbv1 0 Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbv1_0_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbv1_0_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: tulip eight guitar
* oomp_word_emoji :tulip: :eight: :guitar:
* md5_6_alpha: 3v0yv
* md5_6: 62f9a7
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbv1 0 Vertical |  
