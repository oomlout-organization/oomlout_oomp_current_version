# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Mah 0 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3mah_0_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3mah_0_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cow hotel lollipop
* oomp_word_emoji :cow: :hotel: :lollipop:
* md5_6_alpha: 2evuu
* md5_6: 3ddac6
...
| description_extra_name | Jack Xlr Neutrik Nc3Mah 0 Horizontal |  
