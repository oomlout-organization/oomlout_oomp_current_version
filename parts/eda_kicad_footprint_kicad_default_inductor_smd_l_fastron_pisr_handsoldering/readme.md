# Eda Kicad Footprint Kicad Default Inductor SMD L Fastron Pisr Handsoldering  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_inductor_smd_l_fastron_pisr_handsoldering
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: inductor_smd
  * description_extra: l_fastron_pisr_handsoldering
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: foggy door maple_leaf
* oomp_word_emoji :foggy: :door: :maple_leaf:
* md5_6_alpha: 1w6sl
* md5_6: 308b65
...
| description_extra_name | L Fastron Pisr Handsoldering |  
