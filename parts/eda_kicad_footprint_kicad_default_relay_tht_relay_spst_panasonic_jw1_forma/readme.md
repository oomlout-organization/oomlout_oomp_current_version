# Eda Kicad Footprint Kicad Default Relay Tht Relay Spst Panasonic Jw1 Forma  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_relay_tht_relay_spst_panasonic_jw1_forma
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: relay_tht
  * description_extra: relay_spst_panasonic_jw1_forma
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: shoe bus boot
* oomp_word_emoji :shoe: :bus: :boot:
* md5_6_alpha: 6lacr
* md5_6: a8edab
...
| description_extra_name | Relay Spst Panasonic Jw1 Forma |  
