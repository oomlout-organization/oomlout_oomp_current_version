# Eda Kicad Footprint Kicad Default Relay SMD Relay Dpdt Omron G6Sk 2F  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_relay_smd_relay_dpdt_omron_g6sk_2f
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: relay_smd
  * description_extra: relay_dpdt_omron_g6sk_2f
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: door factory baby
* oomp_word_emoji :door: :factory: :baby:
* md5_6_alpha: 5ggf1
* md5_6: 8bdc1d
...
| description_extra_name | Relay Dpdt Omron G6Sk 2F |  
