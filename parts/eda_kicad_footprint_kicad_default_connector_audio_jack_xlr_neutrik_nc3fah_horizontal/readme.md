# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fah Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fah_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fah_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: tophat angel panda_face
* oomp_word_emoji :tophat: :angel: :panda_face:
* md5_6_alpha: 6tzd0
* md5_6: af1e44
...
| description_extra_name | Jack Xlr Neutrik Nc3Fah Horizontal |  
