# Eda Kicad Footprint Kicad Default LED SMD LED Cree Xb  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_led_smd_led_cree_xb
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: led_smd
  * description_extra: led_cree_xb
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: eyes snowflake fish
* oomp_word_emoji :eyes: :snowflake: :fish:
* md5_6_alpha: 1hmc3
* md5_6: 262c53
...
| description_extra_name | LED Cree Xb |  
