# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Faah1 Da Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3faah1_da_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3faah1_da_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: tennis tulip tiger
* oomp_word_emoji :tennis: :tulip: :tiger:
* md5_6_alpha: 5y1q1
* md5_6: 986239
...
| description_extra_name | Jack Xlr Neutrik Nc3Faah1 Da Horizontal |  
