# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 5mm Pad Toponly  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_5mm_pad_toponly
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_6_5mm_pad_toponly
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cloud shirt cherries
* oomp_word_emoji :cloud: :shirt: :cherries:
* md5_6_alpha: 1pcju
* md5_6: 2bacca
...
| description_extra_name | Mountinghole 6 5mm Pad Toponly |  
