# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbh1 Da Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbh1_da_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbh1_da_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: fountain tomato dress
* oomp_word_emoji :fountain: :tomato: :dress:
* md5_6_alpha: 8qegd
* md5_6: dfd3ad
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbh1 Da Horizontal |  
