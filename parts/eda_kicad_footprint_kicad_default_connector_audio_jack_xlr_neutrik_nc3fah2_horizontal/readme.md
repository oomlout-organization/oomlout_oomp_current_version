# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fah2 Horizontal  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fah2_horizontal
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fah2_horizontal
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: pencil hatching_chick ocean
* oomp_word_emoji :pencil: :hatching_chick: :ocean:
* md5_6_alpha: 6dd0x
* md5_6: a34931
...
| description_extra_name | Jack Xlr Neutrik Nc3Fah2 Horizontal |  
