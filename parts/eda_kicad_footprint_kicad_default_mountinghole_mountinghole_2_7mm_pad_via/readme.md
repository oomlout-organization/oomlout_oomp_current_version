# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 2 7mm Pad Via  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_2_7mm_pad_via
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_2_7mm_pad_via
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: clipboard dog ok
* oomp_word_emoji :clipboard: :dog: :ok:
* md5_6_alpha: 5jqwr
* md5_6: 8e33fb
...
| description_extra_name | Mountinghole 2 7mm Pad Via |  
