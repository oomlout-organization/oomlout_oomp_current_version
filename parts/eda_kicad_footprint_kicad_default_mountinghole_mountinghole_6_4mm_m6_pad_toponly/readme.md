# Eda Kicad Footprint Kicad Default Mountinghole Mountinghole 6 4mm M6 Pad Toponly  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_mountinghole_mountinghole_6_4mm_m6_pad_toponly
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: mountinghole
  * description_extra: mountinghole_6_4mm_m6_pad_toponly
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: rice trident pineapple
* oomp_word_emoji :rice: :trident: :pineapple:
* md5_6_alpha: 7evv6
* md5_6: bdffd2
...
| description_extra_name | Mountinghole 6 4mm M6 Pad Toponly |  
