# Eda Kicad Footprint Kicad Default Inductor SMD L Cenker Ckcs6020  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_inductor_smd_l_cenker_ckcs6020
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: inductor_smd
  * description_extra: l_cenker_ckcs6020
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: poodle ok truck
* oomp_word_emoji :poodle: :ok: :truck:
* md5_6_alpha: 3s8a7
* md5_6: 60fbef
...
| description_extra_name | L Cenker Ckcs6020 |  
