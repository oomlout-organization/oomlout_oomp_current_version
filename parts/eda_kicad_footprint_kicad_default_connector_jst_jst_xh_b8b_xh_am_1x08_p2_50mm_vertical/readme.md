# Eda Kicad Footprint Kicad Default Connector Jst Jst Xh B8B Xh Am 1X08 P2 50mm Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_jst_jst_xh_b8b_xh_am_1x08_p2_50mm_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_jst
  * description_extra: jst_xh_b8b_xh_am_1x08_p2_50mm_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: three leaves crocodile
* oomp_word_emoji :three: :leaves: :crocodile:
* md5_6_alpha: 9jase
* md5_6: f4665e
...
| description_extra_name | Jst Xh B8B Xh Am 1X08 P2 50mm Vertical |  
