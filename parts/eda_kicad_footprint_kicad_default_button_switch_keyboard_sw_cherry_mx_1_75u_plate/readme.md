# Eda Kicad Footprint Kicad Default Button Switch Keyboard Sw Cherry Mx 1 75U Plate  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_keyboard_sw_cherry_mx_1_75u_plate
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_keyboard
  * description_extra: sw_cherry_mx_1_75u_plate
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: balloon boot sushi
* oomp_word_emoji :balloon: :boot: :sushi:
* md5_6_alpha: 4qwn0
* md5_6: 79abbc
...
| description_extra_name | Sw Cherry Mx 1 75U Plate |  
