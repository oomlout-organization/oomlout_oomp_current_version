# Eda Kicad Footprint Kicad Default Connector Audio Jack Xlr Neutrik Nc3Fbv2 Da Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_xlr_neutrik_nc3fbv2_da_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_xlr_neutrik_nc3fbv2_da_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: racehorse banana frog
* oomp_word_emoji :racehorse: :banana: :frog:
* md5_6_alpha: 2j1h4
* md5_6: 40d038
...
| description_extra_name | Jack Xlr Neutrik Nc3Fbv2 Da Vertical |  
