# Eda Kicad Footprint Kicad Default Connector Audio Jack Speakon Neutrik Nl2Mdxx V Vertical  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_connector_audio_jack_speakon_neutrik_nl2mdxx_v_vertical
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: connector_audio
  * description_extra: jack_speakon_neutrik_nl2mdxx_v_vertical
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: flags snowman princess
* oomp_word_emoji :flags: :snowman: :princess:
* md5_6_alpha: 4hs7z
* md5_6: 732d1f
...
| description_extra_name | Jack Speakon Neutrik Nl2Mdxx V Vertical |  
