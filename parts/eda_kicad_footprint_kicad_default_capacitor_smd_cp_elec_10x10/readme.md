# Eda Kicad Footprint Kicad Default Capacitor SMD Cp Elec 10X10  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_capacitor_smd_cp_elec_10x10
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: capacitor_smd
  * description_extra: cp_elec_10x10
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: strawberry poodle tram
* oomp_word_emoji :strawberry: :poodle: :tram:
* md5_6_alpha: 80hk8
* md5_6: cd60e8
...
| description_extra_name | Cp Elec 10X10 |  
