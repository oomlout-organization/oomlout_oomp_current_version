# Eda Kicad Footprint Kicad Default Calibration Scale Gauge 50mm Type1 Silkscreentop  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_calibration_scale_gauge_50mm_type1_silkscreentop
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: calibration_scale
  * description_extra: gauge_50mm_type1_silkscreentop
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: book ear ramen
* oomp_word_emoji :book: :ear: :ramen:
* md5_6_alpha: 6ekla
* md5_6: a425be
...
| description_extra_name | Gauge 50mm Type1 Silkscreentop |  
