# Eda Kicad Footprint Kicad Default Optodevice Osram Bpw34S SMD  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_optodevice_osram_bpw34s_smd
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: optodevice
  * description_extra: osram_bpw34s_smd
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cat spaghetti pear
* oomp_word_emoji :cat: :spaghetti: :pear:
* md5_6_alpha: 1z9ap
* md5_6: 32bad1
...
| description_extra_name | Osram Bpw34S SMD |  
