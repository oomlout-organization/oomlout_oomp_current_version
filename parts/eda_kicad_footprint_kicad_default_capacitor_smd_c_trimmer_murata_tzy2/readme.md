# Eda Kicad Footprint Kicad Default Capacitor SMD C Trimmer Murata Tzy2  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_capacitor_smd_c_trimmer_murata_tzy2
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: capacitor_smd
  * description_extra: c_trimmer_murata_tzy2
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: airplane tractor sparkles
* oomp_word_emoji :airplane: :tractor: :sparkles:
* md5_6_alpha: 90cun
* md5_6: e6ea0f
...
| description_extra_name | C Trimmer Murata Tzy2 |  
