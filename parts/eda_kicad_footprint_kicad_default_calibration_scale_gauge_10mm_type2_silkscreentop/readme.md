# Eda Kicad Footprint Kicad Default Calibration Scale Gauge 10mm Type2 Silkscreentop  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_calibration_scale_gauge_10mm_type2_silkscreentop
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: calibration_scale
  * description_extra: gauge_10mm_type2_silkscreentop
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: ambulance tulip beer
* oomp_word_emoji :ambulance: :tulip: :beer:
* md5_6_alpha: 9aunq
* md5_6: ee62b6
...
| description_extra_name | Gauge 10mm Type2 Silkscreentop |  
