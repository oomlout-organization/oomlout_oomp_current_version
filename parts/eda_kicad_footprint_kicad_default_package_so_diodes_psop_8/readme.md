# Eda Kicad Footprint Kicad Default Package So Diodes Psop 8  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_package_so_diodes_psop_8
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: package_so
  * description_extra: diodes_psop_8
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: up monkey rocket
* oomp_word_emoji :up: :monkey: :rocket:
* md5_6_alpha: 9ubj9
* md5_6: fc3ee5
...
| description_extra_name | Diodes Psop 8 |  
