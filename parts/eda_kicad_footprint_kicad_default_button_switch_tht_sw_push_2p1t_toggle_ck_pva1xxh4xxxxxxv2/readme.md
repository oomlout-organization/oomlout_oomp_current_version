# Eda Kicad Footprint Kicad Default Button Switch Tht Sw Push 2P1T Toggle Ck Pva1Xxh4Xxxxxxv2  
...
### id
* oomp_id: eda_kicad_footprint_kicad_default_button_switch_tht_sw_push_2p1t_toggle_ck_pva1xxh4xxxxxxv2
  * classification: kicad_footprint
  * type: kicad_default
  * size: 
  * color: 
  * description_main: button_switch_tht
  * description_extra: sw_push_2p1t_toggle_ck_pva1xxh4xxxxxxv2
  * manufacturer: 
  * part_number: 

### other_codes
* short_code: 
* oomp_word: cat golf book
* oomp_word_emoji :cat: :golf: :book:
* md5_6_alpha: 1z2xw
* md5_6: 329aa4
...
| description_extra_name | Sw Push 2P1T Toggle Ck Pva1Xxh4Xxxxxxv2 |  
